...
const AddExperience = ({ history }) => {
  ...
  return (
    <Fragment>
      ...
      <p className='lead'>
        <i className='fas fa-code-branch'></i> Add any developer/programming positions that you have had in
        the past
      </p>
      ...
      <form className='form' onSubmit={onSubmit}>
        ...
        <div className='form-group'>
          <h4>To Date</h4>
          {/* if the Current Job is checked then we are not able to add To Date */}
